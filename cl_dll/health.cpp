...
int CHudHealth::Draw(float flTime)
{
	...
	if (gHUD.m_iWeaponBits & (1 << (WEAPON_SUIT)))
	{
		...
		gEngfuncs.pTriAPI->TexCoord2f(0.0f, 1.0f); gEngfuncs.pTriAPI->Vertex3f(offsetpoint.x + gHUD.m_flHudLagOfs[0], offsetpoint.y + gHUD.m_flHudLagOfs[1], 0); //top left
		gEngfuncs.pTriAPI->TexCoord2f(0.0f, 0.0f); gEngfuncs.pTriAPI->Vertex3f(offsetpoint.x + gHUD.m_flHudLagOfs[0], offsetpoint.y + 96 + gHUD.m_flHudLagOfs[1], 0); //bottom left
		gEngfuncs.pTriAPI->TexCoord2f(1.0f, 0.0f); gEngfuncs.pTriAPI->Vertex3f(offsetpoint.x + 256 + gHUD.m_flHudLagOfs[0], offsetpoint.y + 96 + gHUD.m_flHudLagOfs[1], 0); //bottom right
		gEngfuncs.pTriAPI->TexCoord2f(1.0f, 1.0f); gEngfuncs.pTriAPI->Vertex3f(offsetpoint.x + 256 + gHUD.m_flHudLagOfs[0], offsetpoint.y + gHUD.m_flHudLagOfs[1], 0); //top right
