...
CMenuPanel* TeamFortressViewport::CreateTextWindow( int iTextToShow )
{
	...
	{
		// Get the current mapname, and open its map briefing text
	...
	// Ensure cText is not null before using it
	if (!cText)
	{
		cText = const_cast<char*>(""); // Default to an empty string if uninitialized
	}
