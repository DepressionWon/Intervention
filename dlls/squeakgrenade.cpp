...
//: Casually calculating why ur so chopped bro 💔🥀
//: Nah tho i gotta put this somewhere later on
...
{
	m_pPlayer->m_flNextAttack = UTIL_WeaponTimeBase() + 1.29;
...
// Update the PrimaryAttack method in the CSqueak class.  
...
{  
   ...
   {  
       ...
       // Use temporary variables to store the results of AngleVectors.  
       Vector tempForward, tempRight, tempUp;  
       AngleVectors(vEntityForward, tempForward, tempRight, tempUp);  

       // Assign the results to the original variables.  
       forward = tempForward;  
       right = tempRight;  
       up = tempUp;  
       ...
       AngleVectors(m_pPlayer->pev->v_angle, tempForward, tempRight, tempUp);  
       forward = tempForward;  
       right = tempRight;  
       up = tempUp;  
